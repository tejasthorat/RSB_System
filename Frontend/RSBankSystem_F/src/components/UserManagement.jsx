...
const UserManagement = ({ isRootUser }) => {
  ...
  const department=["Admin", "Loan","Recovery", " Account", "Computer", "Clearing", "KYC", "Other"];
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      fetchUsers();
      setNewUser({ name: "", userId: "", password: "", email: "", department: "", branch: "", role: "dept_user" });
      setShowModal(false);
        ...
        <div className="modal-overlay">
          <div className="modal-content">
           ...
           { /*<input type="text" name="department" placeholder="Department" value={newUser.department} onChange={handleInputChange} required /> */}
            <select name="department" value={newUser.department} onChange={handleInputChange} required>
